    ...
    return (
        <main className='bg-cover bg-center min-h-screen bg-slate-200' >
            ...
            <ol className="flex flex-col items-start pl-8 mt-12 sm:mt-16">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">01: Custom Web Application Development</h1>
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">02: Responsive UI/UX Design</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">03: Single Page Application (SPA) Development</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">04: Static Site Generation (SSG) & Server-Side Rendering (SSR)</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">05: API Integration & Development</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">06: Component-Based Architecture</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">07: Performance Optimization</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">08: Cross-Browser Compatibility</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">09: E-Commerce Solutions</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
                ...
                {/* CMS Integration */}
                <li className="mb-8">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl ">10: Content Management System (CMS) Integration</h1>
                    <p className="text-lg sm:text-xl lg:text-2xl  mt-4">
